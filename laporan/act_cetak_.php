...
$namafile = "LAPORAN SUPERVISOR ". $userr . " " . $tahun . " " . $validasi;
$user     = isset($_POST['usernya']) ? addslashes($_POST['usernya']) : "";
...
$yi = 30;
    ...
    $ya = $yi + $row;
    $sql = mysql_query("SELECT * FROM detail_barang where validasi='$validasi' AND kode='$userr' AND no_extracom LIKE '%$tahun%' ORDER BY kode_akhir ",$konek);
    $max = 31;
    $row = 6;
