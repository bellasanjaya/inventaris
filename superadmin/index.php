...
<br>Status Anda login sebagai <b> SuperAdmin </b> Jangan lupa LOG OUT sesudah menggunakan aplikasi ini.</span></center>";
?>
...
<b><font size="3" font color="#DC143C">Indonesia Power Unit Jasa Pemeliharaan</font></b></div>
	...
	<tr>
		<td colspan=2><marquee onmouseover="this.stop();" behavior="alternate" onmouseout="this.start();">Halaman Admin</marquee>
		</td>
	</tr>
	<tr>
	...
	<li><a href="?page=superadmin">Data Barang</a></li>
	<li><a href="?page=tampil">Tampilkan Barang</a></li>
	...
	if($page=="superadmin") {
	include "../superadmin/lihat_barang.php";
	$user = $_SESSION['user'];
	} else if ($page=="kode_barang") {
	include "../superadmin/kode_barang.php";
	} else if ($page=="tambah_barang") {
	include "../superadmin/act_vali.php";
	} else if ($page=="act_valid") {
	include "../superadmin/act_valid.php";
	} else if ($page=="valid") {
	include "../superadmin/hasil_validasi.php";
	} else if ($page=="tampil") {
	include "../superadmin/tampil_barang.php";
	} else if ($page=="data") {
	include "../superadmin/data_barang.php";
	}else if ($page=="semua_barang") {
	include "../superadmin/semua_barang.php";
	}
	
	//======== akhir menu barang ================
	
	else if ($page=="lihat_vali") {
	include "../superadmin/lihat_validasi.php";
	} else if ($page=="belum_vali") {
	include "../superadmin/belum_validasi.php";
	}
	...
	include "../laporan/cetak_admin.php";
	$user = $_SESSION['user'];
	} 
	...
	include "../laporan/act_cetak_admin.php";
	$user = $_SESSION['user'];
	} 
